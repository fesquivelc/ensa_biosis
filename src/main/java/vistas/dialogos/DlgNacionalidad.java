...
import controladores.NacionalidadControlador;
 ...
 * @author RyuujiMD
 */
public class DlgNacionalidad extends javax.swing.JDialog {

    /**
     * Creates new form DlgOficina
     * @param padre
     */
    private Nacionalidad seleccion;
    
    public DlgNacionalidad(JInternalFrame padre) {
        super(JOptionPane.getFrameForComponent(padre), true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<Nacionalidad>());
        bindeoSalvaje();
        buscar();
        this.setLocationRelativeTo(padre);
    }
    public DlgNacionalidad(JDialog padre) {
        super(padre, true);
        initComponents();
        listado = ObservableCollections.observableList(new ArrayList<Nacionalidad>());
        bindeoSalvaje();
    ...
    private final List<Nacionalidad> listado;
    private final NacionalidadControlador nc = NacionalidadControlador.getInstance();
    
    private void buscar() {
        String patron = txtOficina.getText();
        listado.clear();
        listado.addAll(nc.buscarXDescripcion(patron));
        tblTabla.packAll();
    }
    ...
    private void bindeoSalvaje() {
        ...
        BeanProperty pNombre = BeanProperty.create("descripcion");
        tablaOficinaBind.addColumnBinding(pNombre).setColumnClass(String.class).setColumnName("Nacionalidad").setEditable(false);
        
        bindeo.addBinding(tablaOficinaBind);
        bindeo.bind();
    }
    
    public Nacionalidad getSeleccionado(){
